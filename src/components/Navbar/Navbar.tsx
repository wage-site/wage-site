...
function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="space-y-2">
      {({ open }) => (
        <>
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 shadow-sm bg-white">
                      ...
                      {({ open }) => (
                        <>
                          <Popover.Button
                            ...
                            aria-current={
                              location.pathname.split("/").includes("proiecte")
                                ? "page"
                                : undefined
                            }
                          >
          ...
          <Transition
            ...
            as={Fragment}
          >
            <Disclosure.Panel className="sm:hidden bg-white shadow-sm m-2 py-1 px-0.5 rounded-lg absolute w-[calc(100%-1.25rem)]">
